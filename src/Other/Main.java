...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("# Tables: " + DBSplit_Knapsack.numTables);
        ...
        System.out.println("Execution Time (s): " + (double) DBSplit_Knapsack.time / 1000 + " s");
        System.out.println("Errors Found: " + DBSplit_Knapsack.getErrors());
    }
